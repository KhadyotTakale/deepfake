...
<h2 className="text-xl font-extrabold tracking-tight text-slate-900">DeepTrace<span className="text-primary">AI</span></h2>
</div>
<nav className="hidden md:flex items-center gap-10">
<a className="text-sm font-semibold text-slate-600 hover:text-primary transition-colors" href="#">Forensics</a>
<a className="text-sm font-semibold text-slate-600 hover:text-primary transition-colors" href="#">API Access</a>
<a className="text-sm font-semibold text-slate-600 hover:text-primary transition-colors" href="#">Enterprise</a>
<a className="text-sm font-semibold text-slate-600 hover:text-primary transition-colors" href="#">Research</a>
</nav>
<div className="flex items-center gap-3">
<button className="hidden sm:block px-4 py-2 text-sm font-bold text-slate-700 hover:text-primary transition-colors">Log In</button>
<button className="rounded-full bg-primary px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all active:scale-95" onClick={onStartScanning}>
                    Start Scanning
                </button>
</div>
</div>
...
<div className="inline-flex items-center gap-2 w-fit rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-xs font-bold uppercase tracking-wider text-primary">
...
<h1 className="text-5xl font-black leading-[1.1] tracking-tight text-slate-900 md:text-7xl">
                            Unmask the Truth with <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent-cyan">AI Forensics</span>
</h1>
...
<button className="flex items-center gap-2 rounded-xl bg-primary px-8 py-4 text-base font-bold text-white shadow-xl shadow-primary/25 hover:shadow-primary/40 transition-all" onClick={onStartScanning}>
                                Analyze Now
...
<div className="text-sm font-bold text-accent-cyan tracking-widest">99.82%</div>
</div>
</div>
</div>
</div>
...
<div className="absolute -right-8 -top-8 -z-0 h-64 w-64 rounded-full bg-primary/5 blur-3xl"></div>
<div className="absolute -left-8 -bottom-8 -z-0 h-64 w-64 rounded-full bg-accent-cyan/10 blur-3xl"></div>
</div>
</div>
</div>
</section>
...
<h2 className="mb-4 text-sm font-bold uppercase tracking-widest text-primary">Core Capabilities</h2>
...
{/* Video Analysis */}
<div className="group relative flex flex-col gap-6 rounded-2xl border border-slate-200 bg-white p-8 transition-all hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5">
<div className="inline-flex h-14 w-14 items-center justify-center rounded-xl bg-slate-50 text-primary transition-colors group-hover:bg-primary group-hover:text-white">
...
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-base">task_alt</span> Heartbeat (rPPG) detection</li>
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-base">task_alt</span> Lip-sync verification</li>
</ul>
</div>
{/* Image Forensics */}
<div className="group relative flex flex-col gap-6 rounded-2xl border border-slate-200 bg-white p-8 transition-all hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5">
...
<ul className="mt-2 space-y-2 text-sm font-medium text-slate-500">
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-base">task_alt</span> Error Level Analysis (ELA)</li>
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-base">task_alt</span> Noise profile matching</li>
</ul>
</div>
...
<ul className="mt-2 space-y-2 text-sm font-medium text-slate-500">
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-base">task_alt</span> Phonetical anomaly detection</li>
<li className="flex items-center gap-2"><span className="material-symbols-outlined text-primary text-base">task_alt</span> Synthetic silence signatures</li>
</ul>
</div>
</div>
</div>
...
<button className="rounded-xl bg-primary px-10 py-5 text-lg font-bold text-white hover:bg-primary/90 transition-all" onClick={onStartScanning}>
                            Get Started Free
                        </button>
...
<a className="h-10 w-10 flex items-center justify-center rounded-full border border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-all" href="#">
...
<li><a className="hover:text-primary transition-colors" href="#">Video Detection</a></li>
<li><a className="hover:text-primary transition-colors" href="#">Audio Forensics</a></li>
...
<li><a className="hover:text-primary transition-colors" href="#">Ethical AI Charter</a></li>
</ul>
</div>
<div>
...
<input className="rounded-lg border-slate-200 bg-white px-4 py-2 text-sm focus:border-primary focus:ring-primary" placeholder="Email address" type="email"/>
